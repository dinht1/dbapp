<?php      
    ...
    if(isset($_POST['SerialNumber'])){
        ...
        $sql = "INSERT INTO `mygoodshoe`.`store` (`SerialNumber`, `ID`, `TransactionID`) VALUES (?,?,?);";

        $ok =$con->prepare($sql);

        
        $ok->bind_param("iii",$SerialNumber, $ID, $TransactionID);

        if (!$ok) { die("Bind param error");} 
        $ok->execute();
        if (!$ok) { die("Exec error"); }
        echo 'Data inserted <a href="Store.php">OK</a>';
...
<body>
    ...
    <div class="mainTitleDiv ">
        ...
        <div class="buttonBar">
            <a class="btn btnID btn-outline-dark btn-lg " href="./index.php" role="button">Shoes</a>
            ...
            <a class="btn btnID btn-outline-dark btn-lg active" href="./Store.php" role="button">Store</a>
        </div>
    </div>
    ...
    <div class="tableArea">
        <table class="table table-bordered table-custom text-center">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><th>".$row["SerialNumber"]."</th><td>".$row["ID"]."</td><td>".$row["TransactionID"]."</td><tr>";
        ...
        <div class="addButton">
            <button type="button" class="btn btn-link btn-lg  btnAdd" data-toggle="modal"
        ...
        <div class="trzButton my-10">
            <div class="trapezoid">
                <button type="button" class="btn btn-link btn-lg">
                    <h6 class="bottomTextSummer"> Spring/Summer</h6>
                </button>
            </div>
            <div class="trapezoid">
                <button type="button" class="btn btn-link btn-lg bottomTextWinter">
                    <h6>Fall/Winter</h6>
                </button>
            </div>
                ...
                <div class="modal-body">
                    <form action="Store.php" method="POST">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col">
                                <input name="TransactionID" type="text" class="form-control" placeholder="Transaction ID">
                            </div>
                        </div>
