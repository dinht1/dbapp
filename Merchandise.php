<?php      
    ...
    if(isset($_POST['SerialNumber'])){
        ...
        $sql = "INSERT INTO `mygoodshoe`.`merchandise` (`SerialNumber`, `Gender`, `Price`) VALUES (?,?,?);";

        $ok =$con->prepare($sql);

        
        $ok->bind_param("isi",$SerialNumber, $Gender, $Price);

        if (!$ok) { die("Bind param error");} 
        $ok->execute();
        if (!$ok) { die("Exec error"); }
        echo 'Data inserted <a href="Merchandise.php">OK</a>';
...
<body>
    ...
    <div class="mainTitleDiv ">
        ...
        <div class="buttonBar">
            ...
            <a class="btn btnID btn-outline-dark btn-lg active" href="#" role="button">Merchandise</a>
        ...
        <table class="table table-bordered table-custom text-center">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><th>".$row["SerialNumber"]."</th><td>".$row["Gender"]."</td><td>".$row["Price"]."</td><tr>";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button  class="btn btn-primary">Add Merchandise</button>
                </div>
                </form>
            </div>
        </div>
