<?php
    ...
    if(isset($_POST['SerialNumber'])){
        ...
        $sql =$conn->prepare("INSERT INTO `mygoodshoe`.`shoes`(`SerialNumber`, `ShoesName`, `Material`, `Gender`, `Description`, `Price`) VALUES (?,?,?,?,?,?)");
        ...
        $ok = $stmt -> bind_param("isisss",$SerialNumber,$ShoesName,$Price,$Material,$Gender,$Description);
