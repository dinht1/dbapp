<?php      
    if(isset($_POST['ID'])){
        ...
        $sql = "INSERT INTO `mygoodshoe`.`storage` (`ID`, `Location`, `Quantity`) VALUES (?,?,?);";

        $ok =$con->prepare($sql);

        
        $ok->bind_param("isi",$ID, $Location, $Quantity);

        if (!$ok) { die("Bind param error");} 
        $ok->execute();
        if (!$ok) { die("Exec error"); }
        echo 'Data inserted <a href="Storage.php">OK</a>';
...
<body>
    ...
    <div class="mainTitleDiv ">
        ...
        <div class="buttonBar">
            ...
            <a class="btn btnID btn-outline-dark btn-lg active" href="./Storage.php" role="button">Storage</a>
        ...
        <table class="table table-bordered table-custom text-center">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><th>".$row["ID"]."</th><td>".$row["Location"]."</td><td>".$row["Quantity"]."</td><tr>";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button  class="btn btn-primary">Add Storage</button>
                </div>
                </form>
            </div>
        </div>
