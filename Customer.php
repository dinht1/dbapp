<?php     
    ...
    if(isset($_POST['CustomerID'])){
        ...
        $sql = "INSERT INTO `mygoodshoe`.`customer` (`CustomerID`, `Fname`, `Lname`) VALUES (?, ?, ?);";
        $ok =$con->prepare($sql);

        
        $ok->bind_param("iss",$CustomerID, $Fname, $Lname);

        if (!$ok) { die("Bind param error");} 
        $ok->execute();
        if (!$ok) { die("Exec error"); }
        echo 'Data inserted <a href="Customer.php">OK</a>';
...
<body>
    ...
    <div class="mainTitleDiv ">
        ...
        <div class="buttonBar">
            ...
            <a class="btn btnID btn-outline-dark btn-lg active" href="#" role="button">Customer</a>
        ...
        <table class="table table-bordered table-custom text-center">
            ...
            <?php              
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><th>".$row["CustomerID"]."</th><td>".$row["Fname"]."</td><td>".$row["Lname"]."</td><tr>";
